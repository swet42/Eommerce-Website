/**
 * @component ModifierDeleteDialog
 * @description Confirmation dialog shown before deleting a modifier.
 *
 * Displays the modifier name:value and warns that products using this
 * modifier may be affected. Uses PrimeReact Dialog with shared theme.
 *
 * Props: visible, onHide, modifier, onConfirm, deleting
...
function ModifierDeleteDialog({ visible, onHide, modifier, onConfirm, deleting }) {
  const footerContent = (
      ...
      <div className="flex flex-col items-center text-center">
        ...
        {modifier && (
          <p className="text-gray-900 dark:text-gray-100 font-semibold text-base mb-4">
            "{modifier.modifier_name}: {modifier.modifier_value}"
          </p>
        )}
        <p className="text-gray-500 dark:text-gray-400 text-xs">
          This action cannot be undone. Products using this modifier may be affected.
        </p>
      </div>
    </Dialog>
  );
...
export default ModifierDeleteDialog;